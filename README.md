...
<head>
    ...
    <style>
        ...
        .stat-card small { font-size: 11px; color: #666; font-weight: bold; text-transform: uppercase; }
        ...
        button { width: 100%; padding: 14px; margin-top: 10px; background: var(--space-blue); color: white; border: none; border-radius: 10px; font-weight: bold; font-size: 16px; cursor: pointer; transition: 0.3s; }
        button:hover { background: #153a75; }
        ...
        .cat-electric { border-left-color: var(--space-gold); } .badge-electric { background: var(--space-gold); color: #000; }
        .cat-plumbing { border-left-color: #3498db; } .badge-plumbing { background: #3498db; }
        .cat-construction { border-left-color: #e67e22; } .badge-construction { background: #e67e22; }
        .cat-general { border-left-color: #9b59b6; } .badge-general { background: #9b59b6; }
...
<div class="container">
    <div class="header">
        <img src="зображення_viber_2026-03-02_14-57-56-329.jpg" alt="ОСББ Космонавтів 52">
    </div>
    ...
    <div class="section">
        ...
        <div style="display: flex; gap: 8px;">
            <input type="text" id="chatMsg" placeholder="Ваше повідомлення..." style="margin:0;">
